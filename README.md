...
[all]
k8s-master1 ansible_connection=local ansible_default_ipv4.address=10.0.0.21 ip=10.0.0.21
k8s-node1 ansible_host=10.0.0.22 ansible_default_ipv4.address=10.0.0.22 ip=10.0.0.22 ansible_port=22 ansible_user=root
k8s-node2 ansible_host=10.0.0.23 ansible_default_ipv4.address=10.0.0.23 ip=10.0.0.23 ansible_port=22 ansible_user=root
k8s-node3 ansible_host=10.0.0.24 ansible_default_ipv4.address=10.0.0.24 ip=10.0.0.24 ansible_port=22 ansible_user=root
#etcd1 ansible_host=10.0.0.21 ansible_default_ipv4.address=10.0.0.21 ip=10.0.0.21 ansible_port=22 ansible_user=root
#etcd2 ansible_host=10.0.0.22 ansible_default_ipv4.address=10.0.0.22 ip=10.0.0.22 ansible_port=22 ansible_user=root
#etcd3 ansible_host=10.0.0.23 ansible_default_ipv4.address=10.0.0.23 ip=10.0.0.23 ansible_port=22 ansible_user=root
...
>
> pause_image: 根据安装的 k8s 版本进行对应的修改
>
...
pause_image: 'registry.cn-hangzhou.aliyuncs.com/google_containers/pause:3.9'          # kubelet 初始化网络使用的基础镜像
...
[all]
k8s-master1 ansible_connection=local ansible_default_ipv4.address=10.0.0.21 ip=10.0.0.21
k8s-master2 ansible_host=10.0.0.22 ansible_default_ipv4.address=10.0.0.22 ip=10.0.0.22 ansible_port=22 ansible_user=root
k8s-master3 ansible_host=10.0.0.23 ansible_default_ipv4.address=10.0.0.23 ip=10.0.0.23 ansible_port=22 ansible_user=root
k8s-node1 ansible_host=10.0.0.24 ansible_default_ipv4.address=10.0.0.24 ip=10.0.0.24 ansible_port=22 ansible_user=root
etcd1 ansible_host=10.0.0.21 ansible_default_ipv4.address=10.0.0.21 ip=10.0.0.21 ansible_port=22 ansible_user=root
etcd2 ansible_host=10.0.0.22 ansible_default_ipv4.address=10.0.0.22 ip=10.0.0.22 ansible_port=22 ansible_user=root
etcd3 ansible_host=10.0.0.23 ansible_default_ipv4.address=10.0.0.23 ip=10.0.0.23 ansible_port=22 ansible_user=root
# 对应更改all.yml 定义的master ip变量
